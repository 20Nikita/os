...
/*!******************************!*\
  !*** ./src/js/algorithms.js ***!
  \******************************/
/*! exports provided: algorithmsEnum, fifo, strf */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "algorithmsEnum", function() { return algorithmsEnum; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fifo", function() { return fifo; });
...
/***/ "./src/js/btnsActions.js":
/*!*******************************!*\
  !*** ./src/js/btnsActions.js ***!
  \*******************************/
/*! exports provided: algoProcess */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "algoProcess", function() { return algoProcess; });
/* harmony import */ var _algorithms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./algorithms */ "./src/js/algorithms.js");
...
var algoProcess = function algoProcess(algorithm, btn) {
  ...
  btn.addEventListener("click", function () {
    ...
    switch (algorithm) {
      case _algorithms__WEBPACK_IMPORTED_MODULE_0__["algorithmsEnum"].FIFO:
        data = Object(_algorithms__WEBPACK_IMPORTED_MODULE_0__["fifo"])(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["generate"])(20));
        break;

      case _algorithms__WEBPACK_IMPORTED_MODULE_0__["algorithmsEnum"].STRF:
        data = Object(_algorithms__WEBPACK_IMPORTED_MODULE_0__["strf"])(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["generate"])(20));
        break;

      case _algorithms__WEBPACK_IMPORTED_MODULE_0__["algorithmsEnum"].UPLOAD_FIFO:
        data = Object(_algorithms__WEBPACK_IMPORTED_MODULE_0__["fifo"])(Object(_preprocess__WEBPACK_IMPORTED_MODULE_2__["loadFileProcess"])());
        break;

      case _algorithms__WEBPACK_IMPORTED_MODULE_0__["algorithmsEnum"].UPLOAD_STRF:
        data = Object(_preprocess__WEBPACK_IMPORTED_MODULE_2__["loadFileProcess"])(); // data = strf(loadFileProcess());
    ...
    var processedData = Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["processArray"])(data);
    Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["paintNums"])(processedData, tactWrapper);
    Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["paintString"])(processedData, cellWrapper);
  });
};

/***/ }),

/***/ "./src/js/curtainsAnim.js":
/*!********************************!*\
  !*** ./src/js/curtainsAnim.js ***!
  \********************************/
/*! exports provided: curtainAnim */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "curtainAnim", function() { return curtainAnim; });
...
var curtainAnim = function curtainAnim() {
  var curtainItems = document.querySelectorAll(".curtain-item");
  ...
  curtainItems.forEach(function (curtain, i) {
    curtain.addEventListener("click", function () {
      tl.to(curtainItems[i], {
        y: -30,
        duration: .6,
        ease: "power1.inOut"
      }).to(curtainItems[i], {
...
/* harmony import */ var _btnsActions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./btnsActions */ "./src/js/btnsActions.js");
/* harmony import */ var _curtainsAnim__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./curtainsAnim */ "./src/js/curtainsAnim.js");
/* harmony import */ var _algorithms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./algorithms */ "./src/js/algorithms.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var fifoBtn = document.getElementById("fifo-generate"),
  ...
  var mainArr = [],
      firstAnim = false;
  Object(_modals__WEBPACK_IMPORTED_MODULE_0__["modalAction"])(); // curtainAnim();

  Object(_btnsActions__WEBPACK_IMPORTED_MODULE_1__["algoProcess"])(_algorithms__WEBPACK_IMPORTED_MODULE_3__["algorithmsEnum"].FIFO, fifoBtn);
  Object(_btnsActions__WEBPACK_IMPORTED_MODULE_1__["algoProcess"])(_algorithms__WEBPACK_IMPORTED_MODULE_3__["algorithmsEnum"].STRF, strfBtn);
  Object(_btnsActions__WEBPACK_IMPORTED_MODULE_1__["algoProcess"])(_algorithms__WEBPACK_IMPORTED_MODULE_3__["algorithmsEnum"].UPLOAD_FIFO, fifoUploadBtn);
  Object(_btnsActions__WEBPACK_IMPORTED_MODULE_1__["algoProcess"])(_algorithms__WEBPACK_IMPORTED_MODULE_3__["algorithmsEnum"].UPLOAD_STRF, strfUploadBtn);
});
...
var modalAction = function modalAction() {
  ...
  arrows.forEach(function (arrow, i) {
    ...
    tl.to(cards[i], {
      top: "50%",
      duration: 1.5
    }, 0).to(cards[i].querySelector(".firstBar"), {
      rotate: 45,
      y: 6,
      width: 25
    }, 0).to(cards[i].querySelector(".thirdBar"), {
      rotate: -45,
      y: 6,
      width: 25
    }, 0).to(cards[i].querySelector(".secondBar"), {
      scaleX: 0,
    ...
    cards[i].querySelectorAll(".btn").forEach(function (btn, i) {// btn.addEventListener("click", () => {
      //     reversed ? tl.reverse() : tl.play();
      //     reversed = !reversed;
      // })
    });
...
/*!******************************!*\
  !*** ./src/js/preprocess.js ***!
  \******************************/
/*! exports provided: loadFileProcess */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadFileProcess", function() { return loadFileProcess; });
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each.js */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
...
var loadFileProcess = function loadFileProcess() {
  var cards = document.querySelectorAll(".card");
  cards.forEach(function (card, i) {
    var uploadBtn = cards[i].querySelector(".btn--upload"); // срабатывает по нажатию кнопки myBtn

    uploadBtn.addEventListener("click", function () {
      // создать файловую переменную
      var reader = new FileReader();
      console.log(reader); // загрузить текст из первого загруженного пользователем файла в переменную reader

      reader.addEventListener('load', function () {
        card.querySelector('.file').innerText = this.result;
      });
      reader.readAsText(cards[i].querySelector('input').files[0]); // срабатывает после загрузки файла

      reader.onload = function () {
        var mainArr = []; // разбить текст в файле на масив строк

        var boof = reader.result.split("\n");
        console.log(boof); // пройтись по каждой строке

        for (var _i in boof) {
          var t = boof[_i].split(", "); // разбить строку на подстроки
